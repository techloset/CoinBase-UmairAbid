...
function LandingPage() {
  return (
    <div>
      <div className="Back h-[1100px] md:h-[1000px]  bg-no-repeat bg-cover  md:bg-center w-[100%] max-md:items-center md:justify-center flex-col flex md:flex-row    ">
      ...
      <div className="w-[100%]  justify-center items-center   flex  md:flex-row flex-col ">
        <div className="w-fit  ">
      ...
      {/* Card */}
      <div className="secBg  w-full mx-auto   h-[1200px] -mt-[300px] bg-no-repeat bg-bottom flex justify-center items-center ">
        <div className="border sm:h-auto  mt-[250px] rounded-[20px] basis-[70%] text-black bg-white flex justify-around  p-[20px]">
