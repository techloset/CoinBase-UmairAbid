...
function Discover() {
    return (
        <div>
            <div className='Discover bg-center bg-cover max-w-[1350px] h-[747px] flex flex-col text-center justify-center items-center'>
                <p className='text-[32px] font-bold leading-[45px] text-[#FFFFFF] max-w-[930px]'>ETH 0 NAIRA EXCHANGE RATE IS NOW #400 PER Transactions</p>
                <p className='text-[#FFFFFF] text-[10px] font-normal mt-10'>19 JUNE, 2019 <span className='border-l px-1'> BUSINESS</span></p>

            </div>
            <div className='w-[60%]  text-[16px] leading-[28px] flex flex-col gap-y-10 justify-center mx-auto'>
            ...
            <div className='flex-col flex md:flex-row justify-center items-center w-full mt-[20px] gap-3 mx-auto'>
                <div className='flex flex-col w-[50%] md:w-[25%]  justify-center items-center gap-28'>
                ...
                <div className='w-[50%] md:w-[25%] h-[100%]'>
                    <img src={Reference} alt="" className='h-[100%]' />

                </div>

            </div>
            <div className='flex flex-col justify-center items-center gap-9 w-[50%] mt-10 mx-auto'>
            ...
            <div className=' flex flex-col md:flex-row justify-between w-[50%] gap-10 mt-[100px] mx-auto items-center'>
                <div>
                    <p className='text-[#333333] text-[16px] font-bold italic '>Tags: Business, Capital, Finance</p>
                </div>
            ...
            <div className='flex flex-col md:flex-row  justify-between w-[50%]  gap-10 mt-[70px] mx-auto   items-center '>
                <div className='flex  w-[268px] flex-col gap-5'>
                    <p className='   text-[18px] text-left font-bold text-[#2F2F2F]'>How to sell your iTunes giftcard with us</p>
                    <p className='text-[12px] font-normal text-[#989898]'>Prev Post</p>
                </div>
                <div className='flex w-[209px] flex-col  gap-5'>
                    <p className=' text-[18px] bg-gradient-to-b from-pink-500 to-indigo-700 text-transparent bg-clip-text font-bold leading-[25px] text-right'>Exchange 5 products and get 1 free product</p>
                    <p className='text-[12px] font-normal text-right text-[#989898]'>Next Post</p>
                </div>
            </div>
            <div className='flex flex-col justify-center w-[50%] mx-auto mt-[150px]'>
                <p className='text-[24px] font-bold text-[#333333]'>Leave A Comment</p>
                <p className='text-[16px] font-normal text-[#333333] max-w-[558px] '>Your email address will not be published. Required fields are marked *</p>
