...
function Footer() {
    return (
        <div className=' flex justify-between  mx-auto w-[100%] border bg-black '>
            <div className='flex justify-between w-[90%] mx-auto'>
                <div className='flex flex-col w-[80%] sm:w-[50%] max-sm:mx-auto md:w-[35%] lg:w-[25%] justify-center mt-14 lg:mt-20   '>
                    <div >
                        <img src={Logo} alt="" className='w-[50%] mb-7 lg:mb-10  ' />
                        <p className='text-[14] font-normal  leading-[24px] text-gray-500'> Fusce ut elit aliquet, fermentum leo vel, tempus nunc. Fusce eu rhoncus augue. Fusce vel metus pharetra, fermentum</p>
                    </div>
                    ...
                    <p className='text-gray-800 mt-8 mb-2 w-[213px] whitespace-nowrap '>© 2019  Designed by Cr8tiv_yemmy</p>
                </div>
                <div className='hidden sm:flex flex-col w-[25%] ml-[70px] max-lg:ml-[100px]  mt-[70px] '>
                    <p className='text-[18px] font-normal text-white flex-col sm:flex whitespace-nowrap'>CoinBase Links</p>
                    <ul className='text-[14px] font-normal text-gray-500 mt-[20px] '>
                ...
                <div className='hidden md:flex sm:flex-col mt-[69px]  w-[25%]  '>
                    ...
                    <ul className='text-[12px] font-normal text-gray-500 mt-[20px] '>
                        <li className='pt-2'>(+234) 137632128</li>
                        <li className='pt-2'>   Coinbase@yahoo.com</li>
                        <li className='pt-2'>Address goes here</li>
                    </ul>
                    <p className='text-[12px] font-normal text-gray-500 pt-20'>Download Our App</p>
                </div>
                <div className='hidden lg:flex flex-col w-[25%]   mt-16 '>
                    <p className='text-[18px] font-normal text-white mb-10 '>CoinBase Instagram</p>
